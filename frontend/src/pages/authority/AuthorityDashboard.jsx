...
import { WorkerAnalyticsMini } from '../../features/authority/components/WorkerAnalytics/WorkerAnalyticsMini'

const MAPBOX_TOKEN = import.meta.env.VITE_MAPBOX_TOKEN || 'pk.eyJ1IjoiZXhhbXBsZSIsImEiOiJjbGV4YW1wbGUifQ.example';

const OnboardWorkerModal = ({ isOpen, onClose, onCreated }) => {
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-8 border-b bg-slate-50">
                            <h3 className="text-xl font-black text-slate-900">Provision New Worker</h3>
                            <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Field Force Onboarding</p>
                        </div>
                        <form onSubmit={handleSubmit} className="p-8 space-y-6">
                            ...
                            >
                                {submitting ? 'Registering...' : 'Initialize Worker Account'}
                            </button>
                        </form>
                    </motion.div>
                </div>
        ...
        <div className="flex h-screen bg-[#F8FAFC]">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-auto p-10">
                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                                <div className="flex justify-between items-center">
                                    ...
                                    <button 
                                        ...
                                        className="ml-8 px-8 py-5 bg-slate-900 text-white rounded-[2rem] font-black uppercase tracking-widest text-xs flex items-center gap-3 hover:bg-slate-800 transition-all shadow-xl shadow-slate-200"
                                    >
                    ...
                    <OnboardWorkerModal 
                        isOpen={showOnboardWorker} 
                        onClose={() => setShowOnboardWorker(false)} 
                        onCreated={fetchData} 
                    />
                </main>
            </div>
